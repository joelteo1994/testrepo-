...
def get_scatter_chart(entered_site, payload_range):
    if entered_site == 'All': 
        ...
        filtered_df2 = spacex_df[spacex_df['Payload Mass (kg)'] in payload_range]
        fig = px.scatter(filtered_df2, x='Payload Mass (kg)', y='class', color='Booster Version Category', title='Correlation between Payload and Success for {}'.format(entered_site))
        return fig
